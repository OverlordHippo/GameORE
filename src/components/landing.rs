...
pub fn Landing() -> Element {
    ...
    rsx! {
        ...
        div {
            ...
            Hero {
                title: "Mining just got even more fun.",
                subtitle: &"Now everyone can mine ORE while they play."
            }
            Block {
                title: &"Proof of work.",
                title2: &"On Solana.",
...
fn Hero(title: String, subtitle: String) -> Element {
    ...
    rsx! {
        div {
            class: "flex flex-col min-h-dvh h-lvh w-full snap-start snap-always",
            Navbar {}
            div {
                class: "flex flex-col flex-grow", // Removed justify-between
                div {
                    class: "flex flex-col gap-y-8 sm:gap-y-10 md:gap-y-12 w-full md:mx-auto px-4 md:px-8",
                    div {
                ...
                div {
                    class: "flex items-center justify-center mt-16 md:mt-32", // Changed pt-24 to mt-8 md:mt-16
                    Link {
                        class: "text-center sm:text-lg md:text-xl lg:text-2xl font-semibold transition-colors transition-transform hover:scale-105 hover:shadow {cta_color} px-6 py-3 rounded-full",
                        to: Route::Home {},
                        "Enter the Mines →"
                    }
                }
